...
def get_args():
    ...
    parser.add_argument(
        "--task",
        choices=["asr", "dialect_classification"],
        default="asr",
    ...
    parser.add_argument(
        "--model",
        choices=["XLSR53", "XLSR_300M", "XLSR_1B", "XLSR_2B"],
        required=True,
    ...
    parser.add_argument("--eta", default=0.0009, type=float, help="learning rate")
...
def main():
    ...
    train_loader = DataLoader(
        train_set, shuffle=True, batch_size=args.batch_size, collate_fn=dynamic_padding
    )
    dev_loader = DataLoader(
        dev_set, shuffle=True, batch_size=args.batch_size, collate_fn=dynamic_padding
    )
